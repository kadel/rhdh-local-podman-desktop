...
import RHDHLocal from './RHDHLocal.svelte';
...
<!--
  ...
  For example, the main page of the application is the "RHDHLocal" svelte component.
...
-->
<Route path="/*" breadcrumb="RHDH Local" isAppMounted={isMounted} let:meta>
  <main class="flex flex-col w-screen h-screen overflow-hidden bg-[var(--pd-content-bg)]">
    <div class="flex flex-row w-full h-full overflow-hidden">
      <Route path="/" breadcrumb="RHDH Local Dashboard">
        <RHDHLocal />
      </Route>
    </div>
  </main>
